...
public class StepDefinitions {
	...
	public void register_as_name_with_email_mobile_and_password(String name, String email, String mobile, String pass)
			throws Exception {
		HttpPost request = new HttpPost("http://localhost:8090/customers");  // Post request to the back end
		...
		request.addHeader("content-type", "application/json"); // adding http headers
